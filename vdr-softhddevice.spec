...
%changelog
* Tue Sep 01 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.5.0-1
- Update to 2.5.0

* Sat Aug 22 2026 Leigh Scott <leigh123linux@gmail.com> - 2.4.8-5
- Rebuild for new ffmpeg

* Sun Aug 02 2026 RPM Fusion Release Engineering <leigh123linux@rpmfusion.org> - 2.4.8-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.8-3
- Rebuilt for new VDR 2.8.2 API version 13

* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.8-2
- Rebuilt for new VDR 2.8.1 API version 12

* Wed Feb 25 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.8-1
- Update to 2.4.8

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.6-5
- Rebuilt for new VDR API version 2.7.9

* Tue Feb 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.6-4
...
* Wed Aug 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.6-1
- Update to 2.4.6

* Fri Aug 01 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.5-5
- Rebuilt for new VDR API version 2.7.7

* Sun Jul 27 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.4.5-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat Jun 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.5-3
- Rebuilt for new VDR API version 2.7.6

* Tue May 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.5-2
...
* Tue Jan 28 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.3-1
- Update to 2.4.3

* Tue Jan 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.2-1
- Update to 2.4.2

* Wed Dec 25 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.4.1-1
- Update to 2.4.1

* Tue Dec 17 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-1
- Update to 2.4.0

* Mon Oct 21 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.8-2
- Rebuilt for new VDR API version 2.7.3

* Wed Sep 25 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.8-1
- Update to 2.3.8

* Sat Jul 27 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.7-1
- Update to 2.3.7

* Sat Jul 27 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.7-1
- Update to 2.3.7

* Fri Jul 26 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.6-2
- Rebuilt for new VDR API version 2.6.9

* Mon Jul 22 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.6-1
- Update to 2.3.6

* Fri Jul 12 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.5-2
- Rebuilt for new VDR API version 2.6.8

* Tue Jul 09 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.5-1
- Update to 2.3.5

* Mon Jun 10 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.3-1
- Update to 2.3.3

* Tue Jun 04 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.2-1
- Update to 2.3.2

* Tue May 21 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.1-1
- Update to 2.3.1

* Sat May 11 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.3.0-1
- Update to 2.3.0

* Thu May 02 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.2.0-1
- Update to 2.2.0

* Sun Apr 21 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.1.2-2
- Rebuilt for new VDR API version

* Mon Mar 18 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.1.2-1
- Update to 2.1.2

* Sat Mar 09 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.1.1-1
- Update to 2.1.1

* Tue Feb 06 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.1.0-1
- Update to 2.1.0

* Sun Feb 04 2024 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.0.9-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 26 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.0.9-2
- Rebuilt for new VDR API version

* Mon Jan 08 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.0.9-1
- Rebuilt for new VDR API version
- Update to 2.0.9

* Fri Jan 05 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.0.8-2
- Rebuilt for new VDR API version

* Tue Jan 02 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.0.8-1
- Update to 2.0.8

* Sat Dec 02 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.7-1
- Update to 2.0.7

* Sat Nov 04 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.6-1
- Update to 2.0.6

* Mon Oct 23 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.5-1
- Update to 2.0.5

* Wed Oct 18 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.4-1
- Update to 2.0.4

* Sat Oct 14 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.3-1
- Update to 2.0.3

* Wed Oct 11 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.2-1
- Update to 2.0.2

* Mon Oct 09 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.1-1
- Update to 2.0.1

* Sun Oct 08 2023 Martin Gansser <martinkg@fedoraproject.org> - 2.0.0-1
- Update to 2.0.0

* Tue Sep 12 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.12.3-1
- Update to 1.12.3

* Wed Sep 06 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.12.2-1
- Update to 1.12.2

* Mon Aug 14 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.12.1-1
- Update to 1.12.1

* Sun Aug 06 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.12.0-1
- Update to 1.12.0

* Wed Aug 02 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.11.2-1
- Update to 1.11.2

* Thu Jul 20 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.11.1-1
- Update to 1.11.1

* Mon Jul 17 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.11.0-1
- Update to 1.11.0

* Wed Jul 05 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.10.3-1
- Update to 1.10.3

* Thu Jun 29 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.10.2-1
- Update to 1.10.2

* Thu Jun 22 2023 Martin Gansser <martinkg@fedoraproject.org> - 1.10.1-1
- Update to 1.10.1
